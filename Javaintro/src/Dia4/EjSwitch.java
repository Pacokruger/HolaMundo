...
(suponemos que se trata del tipo de motor de una bomba para mover fluidos). Definir una variable tipoMotor y permitir que el usuario ingrese un valor entre 1 y 4. El programa debe mostrar lo siguiente:
...
public class EjSwitch {
    ...
    public static void main(String[] args) {
     ...
     int num1;
        ...
        System.out.println("Para bomba de agua ingrese 1");
     System.out.println("Para bomba de gasolina ingrese 2");
     System.out.println("Para bomba de hormigon ingrese 3");
     System.out.println("Para bomba de pasta alimenticia ingrese 4");
     System.out.println("Ingrese el numero de la bomba q desea");
     num1 = leer.nextInt();
     switch (num1){
