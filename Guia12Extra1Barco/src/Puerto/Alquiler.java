...
public class Alquiler {
    ...
    public void crearAlguiler(Barco BarcoAlquilado){
    ...
    public Alquiler(String nombre, int clienteDni, LocalDate fechaAlquiler, LocalDate fechaDevolucion, int posAmarre, Barco Barco) {
        this.nombre = nombre;
